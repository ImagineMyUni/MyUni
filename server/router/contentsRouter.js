...
import { getVideoList, getVideo, getVideoPost, postVideoPost, postScoreConverter, getScoreConverter, getUniversityRegister, postUniversityRegister, getReviewPost } from '../controller/contentsController';
import { onlyPrivate } from '../middleware/auth';

const contentsRouter = express.Router();

contentsRouter.get(routes.review_post, getReviewPost);
